...
var ajaxCart = (function(module, $) {
  ...
  ==============================================================================*/
	...
	adjustCart = function (form) {
		...
		$body.on('click', '.button_eraser1', function() {

			$('#input_value1').val(0);
			$('.icon-minus1').trigger("click");

		});


		$body.on('click', '.button_eraser2', function() {
			$('#input_value2').val(0)
			$('.icon-minus2').trigger("click");
			;
		});

		$body.on('click', '.button_eraser3', function() {
			$('#input_value3').val(0);
			$('.icon-minus3').trigger("click");

		});

		$body.on('click', '.button_eraser4', function() {
			$('#input_value4').val(0);
			$('.icon-minus4').trigger("click");

		});

		$body.on('click', '.button_eraser5', function() {
			$('#input_value5').val(0);
			$('.icon-minus5').trigger("click");

		});

		$body.on('click', '.button_eraser6', function() {
			$('#input_value6').val(0);
			$('.icon-minus6').trigger("click");

		});

		$body.on('click', '.button_eraser7', function() {
			$('#input_value7').val(0);
			$('.icon-minus7').trigger("click");

		});

		$body.on('click', '.button_eraser8', function() {
			$('#input_value8').val(0);
			$('.icon-minus8').trigger("click");

		});

		$body.on('click', '.button_eraser9', function() {
			$('#input_value9').val(0);
			$('.icon-minus9').trigger("click");

		});

		$body.on('click', '.button_eraser10', function() {
			$('#input_value10').val(0);
			$('.icon-minus10').trigger("click");

		});

    
		$body.on('click', '.button_eraser11', function() {

			$('#input_value11').val(0);
			$('.icon-minus11').trigger("click");

		});


		$body.on('click', '.button_eraser12', function() {
			$('#input_value12').val(0)
			$('.icon-minus12').trigger("click");
			;
		});

		$body.on('click', '.button_eraser13', function() {
			$('#input_value13').val(0);
			$('.icon-minus13').trigger("click");

		});

		$body.on('click', '.button_eraser14', function() {
			$('#input_value14').val(0);
			$('.icon-minus14').trigger("click");

		});

		$body.on('click', '.button_eraser15', function() {
			$('#input_value15').val(0);
			$('.icon-minus15').trigger("click");

		});

		$body.on('click', '.button_eraser16', function() {
			$('#input_value16').val(0);
			$('.icon-minus16').trigger("click");

		});

		$body.on('click', '.button_eraser17', function() {
			$('#input_value17').val(0);
			$('.icon-minus17').trigger("click");

		});

		$body.on('click', '.button_eraser18', function() {
			$('#input_value18').val(0);
			$('.icon-minus18').trigger("click");

		});

		$body.on('click', '.button_eraser19', function() {
			$('#input_value19').val(0);
			$('.icon-minus19').trigger("click");

		});

		$body.on('click', '.button_eraser20', function() {
			$('#input_value20').val(0);
			$('.icon-minus20').trigger("click");
